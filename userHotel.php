...
$_SESSION['current_page'] = 'hotel_selection'; 
?>
...
<body>
    <div class="header" style="height: 200px" >
      <div class="navbar1" style="background: rgba(0, 0, 0, 0.9); text-align: start;">
        ...
        <a href="../user/hotelBookings.php">Bookings</a>
       ...
       <?php
        ...
        echo '
          <div class="feature-full-1col co-md-4" style="margin-bottom: 50px">
            ...
            <div class="desc" style="height: 24em";>
              ...
              <a class="book-now text-center" data-hotel-id="' . $row["hotelId"] .' "  onclick="addReservation()"><i class="ti-calendar"></i> Book Now </a>
  ...
  <form id="reservationForm" action="reserveHotel.php" method="POST">
          ...
          <div class="window-content">
              ...
              <h2 style= "text-align: center">Make Your Reservation</h2>
                ...
                <div class="elem-group inlined">
                  ...
                  <input type="number" id="rooms" name="rooms" placeholder="nb of rooms" min="1" required>
                </div>
