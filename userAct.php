...
$_SESSION['current_page'] = 'activity_selection'; 
?>
...
<body>
    <div class="header" style="height: 200px" >
      <div class="navbar1" style="background: rgba(0, 0, 0, 0.9); text-align: start;">
        ...
        <a href="../user/userEvent.php">Events</a>
        <a href="../user/actBookings.php">Bookings</a>
       ...
       <div class="row">
        ...
        echo '
          <div class="feature-full-1col co-md-4" style="margin-bottom: 50px" data-name='.$row['title'].'>
            ...
            <div class="desc" style="height: 26em";>
              <h3 style="text-align: left; margin-top: 10px; width: fit"  >'.$row['title'].'</h3>
              ...
              if ($row['booking']){
                echo ' <a class="book-now text-center" data-activity-id="' . $row["activityId"] .' "  onclick="addReservation()"><i class="ti-calendar"></i> Book Now</a>';
                 }
    ...
    <form id="reservationForm" action="reserveAct.php" method="POST">
      <div id="modalContainer" class="window">
          <div class="window-content">
              ...
              <div class="elem-group inlined">
                ...
                <div class="elem-group inlined">
                  <label for="check_in-time">Check-In_Time</label>
                  <input type="time" id="check_in-date" name="check_in_time" required>
                  <input type="hidden" id="ActIdInput" name="ActivityId">
              </div>
...
document.querySelectorAll('.book-now').forEach(a => {
    a.addEventListener('click', function() {
        let hotelId = this.getAttribute('data-Activity-id');
        document.getElementById('ActIdInput').value = hotelId;
