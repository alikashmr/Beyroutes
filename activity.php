...
<html lang="en">
        ...
        echo '
          <div class="feature-full-1col co-md-4" style="margin-bottom: 50px" data-name='.$row['title'].'>
            ...
            <div class="desc" style="height: 26em";>
              ...
              if ($row['booking']){
             echo ' <a class="book-now text-center" href="../user/Login.php"><i class="ti-calendar"></i> Book Now</a>';
              }
  ...
  <iframe src="https://www.google.com/maps/d/embed?mid=1Mh_iMtz17GXasMBvxUGlanfaFiSddqU&ehbc=2E312F" width="640" height="480"></iframe>
  </div>
